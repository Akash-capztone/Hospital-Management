    ...
    <Layout>
      <div className="flex flex-col h-screen bg-gray-100 border shadow-xl">
        ...
        <div className="p-4 bg-white flex items-center space-x-4 border-t shadow-md">
          ...
          <button className="bg-NavBg text-white px-4 py-2 rounded hover:bg-Hover flex items-center"><FaPaperclip /></button>
          <button className="bg-NavBg text-white px-4 py-2 rounded hover:bg-Hover flex items-center" onClick={sendMessage}><FaPaperPlane /></button>
        </div>
      </div>
    </Layout>
  );
